...
function edit_item()
{
    ...
    $sql = "SELECT bp.`id`, bp.`page_meta_data_id`, pmd.`heading`,pmd.`short_description`, pmd.`description`, 
        pmd.`thumb_photo`, pmd.`photo`, pmd.`url`, pmd.`introduction`, pmd.`title`, pmd.`meta_description`, 
        pmd.`og_title`, pmd.`og_image`, pmd.`updated_by`,
...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
    ...
    <tr>
        <td width="130" valign="top"><label for="photo">Photo:</label></td>
        <td>
    ...
    <tr>
        <td width="150" valign="top"><label for="short_description">Short Description:</label></td>
        <td colspan="3">
            <textarea name="short_description" id="short_description" class="check-max" style="width:718px;min-height:100px;" maxlength="250">$short_description</textarea>
            <br><span class="text-muted"><small>Short description should be maximum 250 characters (including spaces) <em> - 0 character typed</em></small></span>
        </td>
    </tr>    
</table>
<script>
