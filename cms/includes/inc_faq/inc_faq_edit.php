...
function edit_item()
{
    ...
    $sql = "SELECT `id`, `question`, `answer`, `status`, `rank` FROM `faq` WHERE `id` = '{$id}' LIMIT 1";
...
$settings_content = <<< HTML
    <table width="100%" border="0" cellspacing="0" cellpadding="8">
        ...
        <tr>
            ...
            <td valign="top">
                <textarea name="answer" id="answer" class="check-max" style="width:718px;min-height:200px;">$answer</textarea>
                <br>
            </td>
        </tr>
    </table>
