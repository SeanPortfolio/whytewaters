...
function edit_item() 
{
    ...
    $sql = "SELECT gp.`id`, gp.`slideshow_type`, gp.`parent_id`, pmd.`slideshow_id`, pmd.`gallery_id`, 
        gp.`template_id`, gp.`is_category`, gp.`access_level`,
        pmd.`publish_on`, pmd.`hide_on`, pmd.`time_based_publishing`, pmd.`id` AS meta_data_id, 
        pmd.`name`, pmd.`url`, pmd.`full_url`, pmd.`page_meta_index_id`, pmd.`menu_label`,
        pmd.`footer_menu`, pmd.`heading`, pmd.`sub_heading`, pmd.`introduction`, 
        pmd.`quicklink_heading`, pmd.`quicklink_photo`, pmd.`quicklink_thumb_photo`, pmd.`quicklink_menu_label`, 
        pmd.`photo`, pmd.`thumb_photo`, pmd.`photo_caption`, pmd.`title`,
    ...
    $quicklink_sub_heading    = $row['quicklink_sub_heading'];
    $quicklink_photo          = $row['quicklink_photo'];
    $quicklink_thumb_photo    = $row['quicklink_thumb_photo'];
    ...
    $is_category_checked    = ( $is_category == FLAG_YES ) ? ' checked="checked"' : '';

    $time_is_hidden         = ($page_timebase_publishing == FLAG_NO) ? ' class="hidden"' : '';
    $time_is_checked        = ($page_timebase_publishing == FLAG_YES) ? ' checked="checked"' : '';
...
HTML;
        ...
        $url = <<< HTML
        <td width="200"><label for="page_url">URL</label></td>
...
HTML;
    ...
    $settings_content = <<< HTML
        <table width="100%" border="0" cellspacing="0" cellpadding="6">
            ...
            <tr>
                <td width="200"><label for="page_label">CMS Page Label:</label></td>
                <td><input name="page_label" type="text" id="page_label" value="$page_label" style="width:250px;"/></td>
            </tr>
            <tr>
                <td width="200"><label for="page_menu">Menu:</label> <span class="tooltip" title="Leave empty if you do not want it to appear on the main menu"></span></td>
                <td><input name="page_menu" type="text" id="page_menu" value="$page_menu" style="width:250px;" /></td>
            </tr>
            <tr>
                <td width="200"><label for="page_footer">Footer Menu:</label> <span class="tooltip" title="Leave empty if you do not want it to appear on the footer menu"></span></td>
                <td><input name="page_footer" type="text" id="page_footer" value="$page_footer" style="width:250px;" /></td>
            </tr>
            <tr>
                <td width="200"><label for="template_id">Template:</label></td>
                <td>$template_dd</td>
            </tr>
            <tr>
                $parentlist
            ...
            <tr>
                <td width="200"><label for="page_photo_caption">Heroshot Caption:</label></td>
...
HTML;
    ...
    <table width="100%" cellpadding="6" cellspacing="0" border="0">
        <tr>
            <td width="150"><label for="quicklink_heading">Quicklink Heading:</label></td>
            <td><input name="quicklink_heading" type="text" id="quicklink_heading" value="$quicklink_heading" style="width:300px;" /></td>
        </tr>
        <tr>
            <td width="150"><label for="quicklink_photo">Quicklink Heroshot:</label></td>
            <td>
                <input name="quicklink_photo" type="text" value="$quicklink_photo" style="width:300px;" data-thumb-elm="#quicklink_thumb_photo" id="quicklink_photo" readonly autocomplete="off">
                <input name="quicklink_thumb_photo" type="hidden" value="$quicklink_thumb_photo" id="quicklink_thumb_photo" readonly autocomplete="off">

                <input type="button" value="browse" onclick="openFileBrowser('quicklink_photo')"> 
                <input type="button" value="clear" onclick="clearValue('quicklink_photo')"><br>
            </td>
        </tr>
        <tr>
            <td width="150"><label for="quicklink_menu_label">Button Label:</label></td>
            <td><input name="quicklink_menu_label" type="text" id="quicklink_menu_label" value="$quicklink_menu_label" style="width:300px;" /></td>
        </tr>
        <tr>
            <td width="150" valign="top"><label for="short_description">Quicklink Description:</label></td>
            <td valign="top">
