...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
    <tr>
        ...
        <td ><input name="heading" type="text" id="heading" value="$heading" style="width:350px;" /></td>
    </tr>
    <tr>
        <td width="130"><label for="label">Name:</label></td>
        <td><input name="label" type="text" id="label" value="$name" style="width:350px;" /></td>
    </tr>
    <tr>
        <td width="130"><label for="menu_label">Menu Label:</label></td>
        <td><input name="menu_label" type="text" id="menu_label" value="$menu_label" style="width:350px;" /></td> 
    </tr>
    <tr>
        <td width="130"><label for="url">URL:</label></td>
        <td colspan="3"><input name="url" type="text" id="url" value="$url" style="width:350px;" /></td>
    </tr>
